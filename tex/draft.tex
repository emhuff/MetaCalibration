...
\todorm{Run a branch (either R/C) with low dispersion but high
  amplitude optical psf aberrations.}
...
\towrite{Give $m_{1,2}$, $a_{1,2}$, $c_{1,2}$ for the chosen
  ...
  from GREAT3 leaderboard to assert that this has done a lot of the work for us.  Quote the
  responsivities and compare to the naive calculation using the observed $p(e)$.  Are the two
  components the same or different?}
