...
4800 Oak Grove Drive, Pasadena, CA 91106, USA \rmcomment{as you did the majority of the work at OSU,
it would be appropriate to have both; that's usually how it's done, I thought?}}
...
\rmcomment{Should cite the recent KIDS paper that does something sort of like Meta-Cal, but with
  model fits to the image rather than the images themselves.  We can comment on the relationship
  between the methods (similar spirit in principle, but I think ours is more flexible in practice at
  accommodating non-sersic-y things).}
...
$\boldsymbol{\gamma}$. \rmcomment{technically they measure/study
  reduced shear\dots} The major observable effect of a weak shear is a
perturbation to the observed ellipticities $\boldsymbol{e}$ of distant
galaxies. The intrinsic properties of galaxies know no preferred
direction, so the mean $\boldsymbol{e}$ should vanish over a wide
enough field. \rmcomment{Not exactly, because intrinsic alignments.}
Weak lensing measurements exploit this intrinsic symmetry, and search
for spatially coherent anisotropies in observed galaxy shapes from
lensing distortions due to foreground matter.
...
to constraining the coefficients of the linear relation \rmcomment{ack
...
(this section is outlines the assumptions that we make, and which may
or may not hold up in reality).
