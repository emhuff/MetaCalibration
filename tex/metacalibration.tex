...
Many shape measures that involve ratios of noisy quantities, and this
...
cases, the sample mean is not a very efficient estimator for the mean
shear response. To deal with this, section~3.4 develops a technique to
handle arbitrary distributions of shear responses. This will work as
long as the the measurement produces an ellipticity estimate which is
