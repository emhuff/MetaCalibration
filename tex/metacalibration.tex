...
\caption{Results of metacalibration for regauss ({\bf left}), KSB ({\bf
    center}) and Linear Moments ({\bf right}) on CGC.}
...
\caption{Results {\it without} metacalibration for the regauss ({\bf left}), KSB ({\bf
    center}), and Linear Moments ({\bf right}) algorithms on the CGC branch.}
