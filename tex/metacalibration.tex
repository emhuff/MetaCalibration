...
\begin{figure*}
\includegraphics[width=0.3\linewidth]{./Plots/rgc-fixedaber-regauss-no_corrections.png}
\caption{ RGC-fixed aberration regaussianization outputs, without metacalibration. Calibration coefficients are inset.}
\end{figure*}
