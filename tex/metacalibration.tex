...
Note that per-object responsivities can be very large in
...
magnitude (as seen in figure~\ref{fig:calibhist}), due to the finite
difference step size $\Delta \mathbf{g}\sim 0.01$.
...
generated by sampling from equation~\eqref{eqn:likelihood}, for instance
