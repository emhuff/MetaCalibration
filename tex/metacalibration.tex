...
and shear measurement pipeline should be run. This provides a measure
...
images with added PSF ellipticity, rather than added shear, allow us
...
performed inside the procedure.
...
known calibration biases [REF; also see figure XXX]. For each of these
...
\toplotemh{Show the shape of the estimator, while somehow accurately
  conveying the histogram binning scheme, for the three shape
  measurement methods.}
\begin{figure}
...
aberrations. {\it Eric, should I add a plot showing why we came to
  these conclusions, i.e., the distributions of defocus and so on for
  outliers?  Or just paraphrase its conclusions?}  {\bf Yes, I think
  that would be helpful.}

\begin{figure}
  \includegraphics[width=0.5\linewidth]{./Plots/rgc-fixedaber-regauss-opt-shear_plots.png}
  \caption{Results of metacalibration for regauss on RGC with large
    fixed aberrations. }
\end{figure}
