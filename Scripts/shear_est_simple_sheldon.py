...
def shear_est(catalogs, truthTable, delta_g = 0.01, weights = True,mc_type=None):
    ...
    for i,catalog in enumerate(catalogs):
        ...
        g1p, _ = shear_avg(e1p,n=nu1_global, scale = sigma1_global/2.)
        g10, _ = shear_avg(e10,n=nu1_global, scale = sigma1_global/2.)
        g1m, _ = shear_avg(e1m,n=nu1_global, scale = sigma1_global/2.)
